...
interface IDAOExpander {
    ...
    function isActivityWhitelisted(address activity) external view returns (bool);
    ...
    function addActivitiesAddress(address activityAddr, uint256 activityType) external;
